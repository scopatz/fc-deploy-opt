...
To demonstrate the three variant WORG methods, an unconstrained once 
...
exactly matching a continuous demand curve is not possible. Slight over- 
...
times. This method does help make radical adjustments to accommodate 
...
yield a sufficient guess of the deployment schedule.
...
possible to a reasonable best-guess. The limiting factor is the number of 
...
in these figures show that the best estimate consistently switches
...
The difference between the stochastic and inner product searches, though,
